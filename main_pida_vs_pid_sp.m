...
set(gca, 'FontSize', fs); 
subplot(2,1,2)
plot(t_PIDA(1:25000),u_PIDA(1:25000),'k','linewidth',1.5)
hold on
plot(t_PID(1:25000),u_PID(1:25000),'--k','linewidth',1.5)
grid on
ylabel('Fc [kg/s]')
xlabel('Time [s]')
ylim([0.1 0.5])
...
set(gca, 'FontSize', fs);
subplot(2,1,2)
plot(t_PIDA(1:25000),u_PIDA(1:25000),'b','linewidth',1.5)
hold on
plot(t_PID(1:25000),u_PID(1:25000),'--b','linewidth',1.5)
grid on
ylabel('Fc [kg/s]')
xlabel('Time [s]')
ylim([0.1 0.5])
...
set(gca, 'FontSize', fs);
subplot(2,1,2)
plot(t_PIDA(1:25000),u_PIDA(1:25000),'r','linewidth',1.5)
hold on
plot(t_PID(1:25000),u_PID(1:25000),'--r','linewidth',1.5)
grid on
ylabel('Fc [kg/s]')
xlabel('Time [s]')
ylim([0.1 0.5])
